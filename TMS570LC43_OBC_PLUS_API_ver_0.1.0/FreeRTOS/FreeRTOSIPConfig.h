...
#define ipconfigHAS_DEBUG_PRINTF	1
	...
	#define FreeRTOS_debug_printf(X)	printk X
#endif
...
#define ipconfigHAS_PRINTF			1
	...
	#define FreeRTOS_printf(X)			printk X
#endif
...
#define ipconfigIP_TASK_PRIORITY			( (configMAX_PRIORITIES - 1)  | portPRIVILEGE_BIT)
...
/* Az EMAC_RX task konfigur憛進�a */
#define ipconfigETHERNET_DRIVER_RX_TASK_BLOCK_TIME 			100	/* Ticks */
#define ipconfigETHERNET_DRIVER_RX_TASK_PRIORITY			( (configMAX_PRIORITIES - 1)  | portPRIVILEGE_BIT)
...
//TODO: nem biztos, hogy ez egy t�� hat撟吶ny implement憛進嚙� az uxRand()-ra
...
/* Maximum h憳 tick id敿� v憳勉on a network buffer felszabadul憳喳垂a */
...
#define configHTTP_ROOT 					""  /* start from root '/' */
...
#define ipconfigFTP_ZERO_COPY_ALIGNED_WRITES	0	// TODO: kider��ni, hogy mi撱系 fagy, ha == 1
