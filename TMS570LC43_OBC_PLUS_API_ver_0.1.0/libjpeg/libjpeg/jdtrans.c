...
static void transdecode_master_selection (jpeg_decompress_struct* cinfo);
...
jvirt_barray_ptr *
jpeg_read_coefficients (jpeg_decompress_struct* cinfo)
{
...
static void
transdecode_master_selection (jpeg_decompress_struct* cinfo)
{
