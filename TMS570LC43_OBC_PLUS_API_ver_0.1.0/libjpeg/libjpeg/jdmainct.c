...
static void process_data_simple_main
	(jpeg_decompress_struct* cinfo, JSAMPARRAY output_buf,
...
static void
alloc_funny_pointers (jpeg_decompress_struct* cinfo)
...
static void
set_wraparound_pointers (jpeg_decompress_struct* cinfo)
...
static void
set_bottom_pointers (jpeg_decompress_struct* cinfo)
...
static void
start_pass_main (jpeg_decompress_struct* cinfo, J_BUF_MODE pass_mode)
{
  my_main_ptr mainp = (my_main_ptr) cinfo->main;
...
static void
process_data_simple_main (jpeg_decompress_struct* cinfo,
...
static void
process_data_crank_post (jpeg_decompress_struct* cinfo,
			 JSAMPARRAY output_buf, JDIMENSION *out_row_ctr,
			 JDIMENSION out_rows_avail)
{
...
void
jinit_d_main_controller (jpeg_decompress_struct* cinfo, boolean need_full_buffer)
{
  my_main_ptr mainp;
