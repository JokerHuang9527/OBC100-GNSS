...
static void
start_pass_upsample (jpeg_decompress_struct* cinfo)
{
...
static void
sep_upsample (jpeg_decompress_struct* cinfo,
...
static void
fullsize_upsample (jpeg_decompress_struct* cinfo, jpeg_component_info * compptr,
		   JSAMPARRAY input_data, JSAMPARRAY * output_data_ptr)
{
...
static void
int_upsample (jpeg_decompress_struct* cinfo, jpeg_component_info * compptr,
	      JSAMPARRAY input_data, JSAMPARRAY * output_data_ptr)
{
  my_upsample_ptr upsample = (my_upsample_ptr) cinfo->upsample;
